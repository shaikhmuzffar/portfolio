    ...
    return (
        <section>
            ...
            <div className='grid grid-cols-2 justify-between text-blackText p-2 lg:p-3 xl:p-5 gap-2  xl:gap-5 ' >
                {/* github */}
                <div className='col-span-1 active:border-2 border-myGreen active:bg-white  p-2 h-[200px] justify-center  flex flex-col items-center rounded-xl bg-gray-50 cursor-pointer '>
                ...
                {/* dribbble */}
                <div className='col-span-1 active:border-2 border-myGreen active:bg-white  p-2 sm:p-3 h-[200px] justify-center  flex flex-col items-center rounded-xl bg-gray-50 cursor-pointer '>
