    ...
    return (
        <section>
            ...
            <div className='grid grid-cols-2 justify-between text-blackText px-10 sm:px-8 md:px-12 lg:p-0  xl:p-5 gap-5 sm:gap-5 xl:gap-4 lg:gap-2 my-8 md:my-10 ' >
                {/* github */}
                <div className='col-span-2  sm:col-span-1  border-myGreen  p-6 lg:p-3 h-[200px] justify-center  flex flex-col items-center rounded-xl bg-gray-50 cursor-pointer select-none active:bg-green-100  '>
