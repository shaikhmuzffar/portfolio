    ...
    return (
        <div className=' md:fixed md:top-0 md:w-full flex items-center h-[90px] z-10 bg-white shadow-lg'>
            <div className='w-full max-w-[83.333333%] mx-auto  flex justify-between items-center'>
                ...
                {/* navigation */}
                <ul className={`${showNav ? 'fixed' : 'hidden'} bg-white space-y-2   shadow-md w-screen p-4 pt-[15vh] pb-8 text-center top-0 right-1  z-10  text-sm md:space-y-0  md:static md:bg-none md:shadow-none md:w-fit md:p-0 md:left-0 md:right-0 md:flex md:flex-row md:gap-x-4 ` } >
